  ...
  return (
    <div className="aboutUs">
      ...
      <div className="ab-banner">
        <img src="https://www.sgcookinglessons.com/wp-content/uploads/2017/05/Fine-Dining-Background.jpg" />
        <p>About Us</p>
      </div>
        ...
        <div className="about-main">
          ...
          <div className="card-list">
            <div className="card">
              ...
              <img src="https://img.freepik.com/premium-photo/crop-faceless-shot-male-chef-uniform-putting-cut-pieces-celery-content-smoothie_222464-1147.jpg?w=2000" />
            </div>
            <div className="card">
              <span className="caption">
                <h2>Chef Son</h2>
